...
def random_perspective(im, targets=(), segments=(), degrees=10, translate=.1, scale=.1, shear=10, perspective=0.0,
    ...
    height = im.shape[0] + border[0] * 2  # shape(h,w)
    ...
    ax[0].imshow(im, cmap="gray")  # base
    ax[1].imshow(im2, cmap="gray")  # warped
    plt.show()
    """

    # save visualize
    """
    cv2.imwrite("/workspace/jiangzongkang/dockerCode/spineData/spine_demo/img_no_affine.png", im)
    cv2.imwrite("/workspace/jiangzongkang/dockerCode/spineData/spine_demo/img_with_affine.png", im2)
    """
