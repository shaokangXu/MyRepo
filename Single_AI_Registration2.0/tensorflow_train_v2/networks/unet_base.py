...
class UnetBase(tf.keras.layers.Layer):
    ...
    def call(self, node, training, **kwargs):
        ...
        self.call_contracting reprsents the contracting part of the U-Net, same like the encoder.
        self.call_paarallel reprsents the parallel block, same like skip connection.
        self.call_expanding_block reprsents the expanding part of the U-Net, same like the decoder.
        :param node: The input node.
        :param training: Training parameter passed to layers.
        :param kwargs: **kwargs
