...
LastEditTime: 2024-11-01 16:25:13
...
def main(opt):
    ...
    for epoch in range(opt.start_epoch ,opt.epochs):
        ...
        for j,line in enumerate(lines):    
            train_loader = DataLoader(CustomDataset(line, opt.xray_per_ct,mode), batch_size = opt.batch_size, shuffle=True, pin_memory=True)
        ...
        #保存最近5次的模型  
        model_path='checkpoint_model/Pose_Net_Single_'+opt.modelName
