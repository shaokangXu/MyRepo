...
LastEditTime: 2024-03-04 11:30:25
...
def Read_Parameters(mode):
    ...
    if mode=="train": 
        ...
        parser.add_argument('--Pose_Net', type=str, default='checkpoint_model/Pose_Net_Single_'+view+'64.pth', help='AP_CNN checkpoint file')
        ...
        parser.add_argument('--step_size', type=float, default=30, help='step_size of lr_scheduler ')
    ...
    if mode=="test":
        #-----------test-------------
        parser.add_argument('--cuda', default= True, help='use GPU computation')
        parser.add_argument('--Pose_Net', type=str, default='checkpoint_model/Pose_Net_Single_'+view+'70.pth', help='AP_CNN checkpoint file')
        parser.add_argument('--batch_size', type=float, default=1, help='batchsize')
        parser.add_argument('--xray_per_ct', type=float, default=100, help='Number of X-rays per CT')
        parser.add_argument('--data_folder', type=str, default='../Single_Dataset/ct_Single_train1.txt', help='Dataset route')
